...
class TapDetailReportReadOnly extends StatefulWidget {
  final Report report;
  const TapDetailReportReadOnly({
    Key? key,
    required this.report,
  }) : super(key: key);

  @override
  State<TapDetailReportReadOnly> createState() => _TapDetailReportReadOnlyState();
}

class _TapDetailReportReadOnlyState extends State<TapDetailReportReadOnly> {
